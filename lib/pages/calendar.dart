    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          SizedBox(width: 120.0, child: Text(headerText, style: const TextStyle(fontSize: 26.0))),
          IconButton(
...
final kEvents = LinkedHashMap<DateTime, List<Event>>(equals: isSameDay, hashCode: getHashCode)
